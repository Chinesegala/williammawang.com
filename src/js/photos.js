document.getElementById('photos').addEventListener('contextmenu', function (event) {
    event.preventDefault();
 });
 
 document.getElementById('img_here').addEventListener('contextmenu', function (event) {
    event.preventDefault();
 });
